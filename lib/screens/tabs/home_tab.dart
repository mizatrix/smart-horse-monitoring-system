...
class _HomeTabState extends State<HomeTab> {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: notifBg, borderRadius: BorderRadius.circular(15),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('EquiGuard', style: GoogleFonts.playfairDisplay(fontSize: 26, fontWeight: FontWeight.bold, color: const Color(0xFF8D6E63))),
                      Text('${AppStrings.get('good_evening', lang)}, Moataz 👋', style: GoogleFonts.poppins(fontSize: 13, color: subtextColor)),
                    ]),
                    GestureDetector(
                      onTap: _showNotifications,
                      child: Container(
                        padding: const EdgeInsets.all(10),
                        decoration: BoxDecoration(color: cardColor, borderRadius: BorderRadius.circular(14), boxShadow: [BoxShadow(color: shadowColor, blurRadius: 8)]),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(colors: [Color(0xFF4DB6AC), Color(0xFF00695C)], begin: Alignment.topLeft, end: Alignment.bottomRight),
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('28°C • ${AppStrings.get('partly_cloudy', lang)}', style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
                    Text('${AppStrings.get('humidity', lang)} 62% • ${AppStrings.get('wind', lang)} 12 km/h • ${AppStrings.get('uv_index', lang)} 5',
                  ...
                  Column(children: [
                    Container(
                      ...
                      child: Text('HSI: 128', style: GoogleFonts.robotoMono(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)),
                    ),
                    const SizedBox(height: 4),
              ...
              // Dashboard Cards Row (3 cards now)
              Row(children: [
                Expanded(child: _buildDashboardCard(AppStrings.get('wellness_dashboard', lang), Icons.speed, const Color(0xFFD2B48C), Colors.white, () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const StatsScreen()));
                })),
                const SizedBox(width: 10),
                Expanded(child: _buildDashboardCard(AppStrings.get('monitoring_management', lang), Icons.shield_outlined, const Color(0xFF00695C), Colors.white, () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const StableManagementScreen()));
                })),
                const SizedBox(width: 10),
                Expanded(child: _buildDashboardCard(lang == 'ar' ? 'التدريب' : 'Training', Icons.fitness_center, const Color(0xFF6D4C41), Colors.white, () {
              ...
              Container(
                height: 45,
                decoration: BoxDecoration(color: searchBg, borderRadius: BorderRadius.circular(15), boxShadow: [BoxShadow(color: shadowColor, blurRadius: 8, offset: const Offset(0, 2))]),
                child: TextField(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    return Padding(
                      ...
                      child: FilterChip(
                        label: Text(filter['label']!, style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w500, color: isSelected ? Colors.white : chipColor)),
                        selected: isSelected,
              ...
              // Horses Header with View All toggle
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('${AppStrings.get('horses', lang)} (${horses.length})', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: textColor)),
                  Row(children: [
                    if (_showAllHorses)
                      TextButton(
                        onPressed: () => setState(() => _showAllHorses = false),
                        child: Text(lang == 'ar' ? 'عرض أقل' : 'Show Less', style: GoogleFonts.poppins(color: const Color(0xFF8D6E63), fontWeight: FontWeight.w500, fontSize: 12)),
                      ),
                    TextButton(
                      onPressed: () => setState(() { _searchQuery = ''; _statusFilter = 'All'; }),
                      child: Text(AppStrings.get('reset', lang), style: GoogleFonts.poppins(color: isDark ? Colors.grey[400] : Colors.grey, fontWeight: FontWeight.w500, fontSize: 12)),
                    ),
                  ]),
                ],
              ),

              // Horse List — Horizontal Carousel or Full List
              if (horses.isEmpty)
                Padding(
              ...
              else if (!_showAllHorses)
                // Horizontal Carousel — shows first 10
                Column(children: [
                  SizedBox(
                    height: 155,
                    child: ListView.builder(
                      scrollDirection: Axis.horizontal,
                      itemCount: horses.length > 10 ? 11 : horses.length, // +1 for "View All" card
                      itemBuilder: (context, index) {
                        if (index == 10) {
                          // View All card
                          return GestureDetector(
                            onTap: () => setState(() => _showAllHorses = true),
                            child: Container(
                              width: 100,
                              margin: const EdgeInsets.only(right: 12),
                              decoration: BoxDecoration(
                                color: const Color(0xFF8D6E63).withOpacity(isDark ? 0.2 : 0.1),
                              ...
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                Container(
                                  ...
                                  child: const Icon(Icons.grid_view_rounded, color: Color(0xFF8D6E63), size: 24),
                                ),
                        ...
                        return _buildHorseCarouselCard(context, horses[index], isDark, lang, cardColor, textColor, subtextColor, shadowColor);
                      },
                    ),
                  ),
                ])
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const AddEditHorseScreen())),
  ...
  Widget _buildHorseCarouselCard(BuildContext context, Horse horse, bool isDark, String lang,
    ...
    return GestureDetector(
      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => HorseDetailsScreen(horse: horse))),
      child: Container(
        width: 130,
        margin: const EdgeInsets.only(right: 12),
        padding: const EdgeInsets.all(12),
            ...
            Hero(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: AssetImage(horse.imageUrl), fit: BoxFit.cover),
                ),
              ),
            ),
            const SizedBox(height: 8),
            Text(horse.name, style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 12, color: textColor), overflow: TextOverflow.ellipsis, maxLines: 1),
            Text(horse.breed, style: GoogleFonts.poppins(color: subtextColor, fontSize: 9), overflow: TextOverflow.ellipsis),
            const SizedBox(height: 6),
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
              decoration: BoxDecoration(color: statusColor.withOpacity(0.1), borderRadius: BorderRadius.circular(8)),
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                Icon(Icons.monitor_heart, color: statusColor, size: 10),
                const SizedBox(width: 3),
                Text('${horse.currentHeartRate.toStringAsFixed(0)}', style: GoogleFonts.poppins(color: statusColor, fontSize: 10, fontWeight: FontWeight.w600)),
              ]),
            ),
          ],
        ),
  ...
  Widget _buildQuickStat(String value, String label, IconData icon, Color color,
    ...
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(color: cardColor, borderRadius: BorderRadius.circular(14), boxShadow: [BoxShadow(color: shadowColor, blurRadius: 6)]),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: bgColor.withOpacity(0.3), blurRadius: 10, offset: const Offset(0, 5))],
        ),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          Text(title, style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 10)),
        ]),
      ),
    );
  }
  ...
  Widget _buildHorseListItem(BuildContext context, Horse horse, bool isDark, String lang,
    ...
    String statusText;
    switch (horse.status) {
      case 'Critical': statusColor = Colors.red; statusText = AppStrings.get('critical', lang); break;
      case 'Warning': statusColor = Colors.orange; statusText = AppStrings.get('warning', lang); break;
      default: statusColor = Colors.green; statusText = AppStrings.get('healthy', lang);
    }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: cardColor, borderRadius: BorderRadius.circular(18), boxShadow: [BoxShadow(color: shadowColor, blurRadius: 10, offset: const Offset(0, 2))]),
        child: Row(children: [
          Hero(
            tag: horse.id,
            child: Container(
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Text('${horse.breed} • ${horse.age} ${AppStrings.get('yrs', lang)}', style: GoogleFonts.poppins(color: subtextColor, fontSize: 11)),
              const SizedBox(width: 6),
              Icon(Icons.monitor_heart, color: isDark ? Colors.grey[600] : Colors.grey[400], size: 12),
              const SizedBox(width: 2),
              Text('${horse.currentHeartRate.toStringAsFixed(0)}', style: GoogleFonts.poppins(color: subtextColor, fontSize: 11)),
            ]),
          ])),
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
            decoration: BoxDecoration(color: statusColor.withOpacity(0.1), borderRadius: BorderRadius.circular(10)),
            child: Text(statusText, style: GoogleFonts.poppins(color: statusColor, fontSize: 11, fontWeight: FontWeight.w600)),
          ),
